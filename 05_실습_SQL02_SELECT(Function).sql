...
select 
case when grouping(substr(term_no,1,4)) = 1 then ' ' else substr(term_no,1,4) end as "년도",
case when grouping(substr(term_no,5,2)) = 1 then ' ' else substr(term_no,5,2) end as "학기", 
